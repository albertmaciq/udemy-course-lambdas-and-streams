...
public class BinaryOperatorApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This is the result of apply BiFunction: "
                + normalizerFunc.apply("hello","World!"));

        BinaryOperator<String> normalizerBinaryFunc = (a, b) -> a.toLowerCase().concat(b.toUpperCase());
        System.out.println("This is the result of apply BinaryOperator: "
                + normalizerBinaryFunc.apply("hello","World!"));
    }
}
